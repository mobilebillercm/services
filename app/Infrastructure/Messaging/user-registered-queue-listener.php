...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $callback = function ($msg) {
        ...
        try {
            ...
            $tokenUrl = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_SERVICES'] . '/oauth/token';
        ...
        try {
            ...
            $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_SERVICES'] . '/api/holders';
